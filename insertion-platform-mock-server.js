...
const PLATFORM_SOURCE = 'insertion_platform';
...
async function runTests() {
    // 1. Single Event Test
    await sendRequest('/gamification/insertion/events', createSingleEventPayload(), 'Insertion Platform: Single Event');

    // Wait 1 second to keep timestamps distinct
    await new Promise(resolve => setTimeout(resolve, 1000));

    // 2. Batch Events Test
    await sendRequest('/gamification/insertion/events/batch', createBatchEventsPayload(), 'Insertion Platform: Batch Events');
}
