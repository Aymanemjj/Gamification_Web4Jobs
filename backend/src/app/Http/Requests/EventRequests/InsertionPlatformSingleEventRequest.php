...
class InsertionPlatformSingleEventRequest extends FormRequest implements
    SourceSingleEventRequestInterface
{
    ...
    public function toDTO(): InsertionPlatformEventDTO
    {
        $data = $this->validated();
        return InsertionPlatformEventDTO::make($data);
    }
}