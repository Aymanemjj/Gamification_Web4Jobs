...
class AttendanceCenterBatchEventRequest extends FormRequest implements
    SourceBatchEventRequestInterface
{
    ...
    public function rules(): array
    {
        ...
        foreach ($this->all() as $index => $item) {
            $rules["$index.source"] = "required|string|in:attendance_center";
    ...
    {
        $data = $this->validated();
        return AttendanceCenterEventDTO::collection($data);
    }
}