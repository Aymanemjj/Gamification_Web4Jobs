...
class CertificationPlatformSingleEventRequest extends FormRequest implements
    SourceSingleEventRequestInterface
{
    ...
    public function rules(): array
    {
        ...
        return [
            "source" => "required|string|in:certification_platform",
            "event_type" => [
                "required",
                "string",
                "max:255",
    ...
    public function toDTO(): CertificationPlatformEventDTO
    {
        $data = $this->validated();
        return CertificationPlatformEventDTO::make($data);
    }
}