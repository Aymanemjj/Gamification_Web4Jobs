...
use App\DTOs\SourcesEvents\ManualContributionEventDTO;
...
class ManualContributionBatchEventRequest extends FormRequest implements
    SourceBatchEventRequestInterface
{
    ...
    public function rules(): array
    {
        ...
        foreach ($this->all() as $index => $item) {
            ...
            $rules["$index.source"] = "required|string|in:manual_contribution";
            ...
            $rules["$index.center_id"] = "nullable|string|max:255";
    ...
    {
        $data = $this->validated();
        return ManualContributionEventDTO::collection($data);
    }
}