...
export default function Table({ table }: { table: Row[] }) {
  ...
  const [itemsPerPage, setItemsPerPage] = useState(10); // Changed from constant to state (Defaulting to 10)
  ...
  // Reset to page 1 whenever the user changes the rows per page limit
  ...
  return (
    <div className="space-y-4">
      {/* Table Element remains exactly the same */}
      ...
      {/* --- Pagination Footer with Rows Selector --- */}
